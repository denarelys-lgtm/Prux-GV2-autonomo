...
public class MainActivity extends AppCompatActivity {
    ...
    private void activarAccesibilidad() {
        ...
        try {
            ...
            if (currentServices == null
                    || !currentServices.contains(serviceName)) {
                ...
                Toast.makeText(
                        this,
                        "Accesibilidad activada automáticamente",
                        Toast.LENGTH_SHORT
                ).show();
            }
            ...
            Toast.makeText(
                    this,
                    "Otorga WRITE_SECURE_SETTINGS vía Bugjaeger",
                    Toast.LENGTH_LONG
            ).show();
            ...
            Log.e(
                    TAG,
                    "Error al activar servicio de accesibilidad",
                    e
            );
        }
    }
    ...
    private void pair() {
        ...
        if (!portText.matches("\\d{1,5}")
            ...
            Toast.makeText(
                    this,
                    "Introduce puerto y código de 6 dígitos",
                    Toast.LENGTH_SHORT
            ).show();
    ...
    private void reconnect() {
        ...
        txtAdbStatus.setText(
                "ADB: buscando conexión autorizada..."
        );

        PruxAdbEngine.get(this).reconnect(
                (ok, msg) -> runOnUiThread(() -> {
    ...
    private void discoverPairingPort() {
        ...
        txtPairingPort.setText(
                "Buscando puerto de emparejamiento..."
        );
                                        ...
                                        public void onServiceResolved(
                                            ...
                                            runOnUiThread(() -> {
                                                ...
                                                if (info.getPort()
                                                    ...
                                                    txtPairingPort
                                                            .setText(
                                                                    "Puerto de emparejamiento detectado: "
                                                                            + info.getPort()
                                                            );
                                                }
                                            });
        ...
        try {
            ...
            txtPairingPort.setText(
                    "No se pudo descubrir el puerto; "
